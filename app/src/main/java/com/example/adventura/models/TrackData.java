...
public class TrackData implements Serializable {
    ...
    public String getOnfly_status() {
        return onfly_status;
    }

    public void setOnfly_status(String onfly_status) {
    ...
    public String getUser_kart_status() {
        return user_kart_status;
    }

    public void setUser_kart_status(String user_kart_status) {
